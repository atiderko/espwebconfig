...
namespace EWC
{
  ...
  public:
     ...
     * @param position: use negative or positive value to shift this menu item on insert. It is only relative to previous inserted items.
    ...
    /** Creates a page with successful result.**/
